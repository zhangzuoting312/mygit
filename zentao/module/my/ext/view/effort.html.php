...
<div id="mainMenu" class="clearfix">
  <div class="btn-toolbar pull-left">
    <?php if(!empty($app->user) and common::hasPriv('effort', 'calendar')) echo html::a($this->createLink('effort', 'calendar'), '<i class="icon icon-back icon-sm"></i> ' . $lang->goback, '', "class='btn btn-primary'") . '<div class="divider"></div>';?>
    <?php
  ...
  <div class="btn-toolbar pull-right">
    <?php if(common::hasPriv('effort', 'export')) echo html::a(helper::createLink('effort', 'export', "userID=$userID&orderBy=date_asc", 'html', true), "<i class='icon-export muted'> </i> " . $lang->effort->export, '', "class='btn btn-link export'") ?>
