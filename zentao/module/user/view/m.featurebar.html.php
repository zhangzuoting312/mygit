...
<nav id='menu' class='menu nav affix dock-top canvas'>
  ...
  echo  html::a($this->createLink('user', 'dynamic',  "type=today&userID={$user->id}"), $lang->user->dynamic, '', "id='dynamicTab'");
  echo  html::a($this->createLink('user', 'project',  "userID={$user->id}"), $lang->user->project, '', "id='projectTab'");
