...
$lang->my->menu->calendar = array('link' => 'Schedule|my|calendar|', 'subModule' => 'todo,effort', 'alias' => 'todo', 'class' => 'dropdown dropdown-hover');

$lang->my->subMenu = new stdclass();
$lang->my->subMenu->calendar = new stdclass();
$lang->my->subMenu->calendar->todo   = 'Todo|my|todo|';
$lang->my->subMenu->calendar->effort = 'Effort|my|effort|';

/* Insert effort into $lang->user->menu.*/
$lang->user->menu->effort = array('link' => 'Effort|company|effort', 'subModule' => 'effort');
