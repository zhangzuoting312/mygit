...
$lang->my->subMenu->calendar->todo   = '待办|my|todo|';
$lang->my->subMenu->calendar->effort = '日志|my|effort|';

/* Insert effort into $lang->user->menu.*/
$lang->user->menu->effort = array('link' => '日志|company|effort', 'subModule' => 'effort');
...
$lang->project->subMenu->list->taskeffort = '工时明细表|project|taskeffort|projectID=%s';
