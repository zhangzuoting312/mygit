...
$lang->project->menu->effort = array('link' => 'Effort|project|effortcalendar|projectID=%s', 'alias' => 'effort');

$lang->company->menu->todo    = 'Todo|company|todo|';
$lang->company->menu->effort  = array('link' => 'Effort|company|calendar|', 'alias' => 'effort');
...
$lang->my->menu->calendar = array('link' => 'Schedule|my|calendar|', 'subModule' => 'todo,effort', 'alias' => 'todo,effort', 'class' => 'dropdown dropdown-hover');

$lang->my->subMenu = new stdclass();
$lang->my->subMenu->calendar = new stdclass();
$lang->my->subMenu->calendar->todo   = array('link' => 'Todo|todo|calendar|', 'alias' => 'todo');
$lang->my->subMenu->calendar->effort = array('link' => 'Effort|effort|calendar|', 'alias' => 'effort');
