...
<table class="table table-bordered table-striped table-condensed table-fixed datatable no-margin" id='effortList'>
  ...
  <tbody>
    ...
    <tr class='text-top'>
      ...
      <td class="text-middle"><?php echo zget($accountPairs, $account);?></td>
...
<div id='mainMenu' class='clearfix'>
  ...
  <div class='btn-toolbar pull-right'><?php common::printIcon('effort', 'export', "userID=$userID&orderBy=date_asc", '', 'button', '', '', 'export');?></div>
</div>
<div id="mainContent" class="main-row fade">
  ...
  <div class="main-col cell">
    <div id='showdata' data-url='<?php echo $this->createLink('company', 'calendar', "dept=$parent&begin=" . strtotime($begin) . "&end=" . strtotime($end) . "&product=$product&project=$project&userID=$userID&showAll=$showAll&iframe=yes")?>'>
