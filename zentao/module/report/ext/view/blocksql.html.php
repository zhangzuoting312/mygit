<div class='panel'>
  ...
  <form method='post' action='<?php echo inlink('custom', "step=1&reportID=$reportID&type=$type")?>' target='hiddenwin' class='sqlForm'>
    ...
    <div style='padding: 0 10px 10px;'>
      ...
      if(common::hasPriv('report', 'saveReport'))
      {
          ...
          echo html::a(inlink('saveReport', "reportID=0&step=$step&type=$type"), $save, '', "class='btn' data-type='iframe' data-toggle='modal'");
          echo '</div>';
      }
      ?>
    </div>
