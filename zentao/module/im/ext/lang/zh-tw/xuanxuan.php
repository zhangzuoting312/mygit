...
$lang->im->info            = "禪道客戶端由易軟天創旗下另外一款免費、開源、安全的IM產品<a href='https://xuan.im/' target='_blank'>喧喧</a>驅動，支持私有部署，跨平台操作，內置大量插件，功能豐富，在喧喧裡，您甚至還可以為自己編寫個性化的插件，<a href='https://xuan.im/' target='_blank'>點擊查看</a>。";
$lang->im->xxClientConfirm = '與禪道深度整合，支持成員溝通，小組討論，檔案傳輸，任務指派，更加方便的項目管理，更加流暢的團隊協作！點擊界面右下角下載禪道客戶端。';
