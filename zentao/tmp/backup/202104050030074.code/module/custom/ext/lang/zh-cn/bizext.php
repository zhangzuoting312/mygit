...
$lang->custom->SRStory = "研发需求";

$lang->custom->conceptQuestions['URAndSR']          = "3. 是否启用用户需求和研发需求概念？";
$lang->custom->conceptQuestions['URSRName']         = "用户需求和研发需求的概念定义？";
$lang->custom->conceptQuestions['requirementpoint'] = "4. 您公司是在使用工时还是功能点来做规模估算？";
