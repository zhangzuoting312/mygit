...
<nav id='menu' class='menu nav affix dock-top canvas'>
  <?php echo html::a(inlink("all", "productID=$productID&line=&status=noclosed"), $lang->product->unclosed, '', "id='noclosedTab'");?>
  <?php echo html::a(inlink("all", "productID=$productID&line=&status=closed"), $lang->product->statusList['closed'], '', "id='closedTab'");?>
  <?php echo html::a(inlink("all", "productID=$productID&line=&status=all"), $lang->product->allProduct, '', "id='allTab'");?>
...
<div class='list sort-panel hidden affix enter-from-bottom layer' id='sortPanel'>
  <?php
  $vars = "productID=$productID&line=&status=$status&orderBy=%s&recTotal={$pager->recTotal}&recPerPage={$pager->recPerPage}&pageID={$pager->pageID}";
