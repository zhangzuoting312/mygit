...
<nav id='subMenu' class='menu nav gray'>
  <?php
  echo html::a(inlink('bug', "userID={$user->id}&type=assignedTo"), $lang->user->assignedTo);
  echo html::a(inlink('bug', "userID={$user->id}&type=openedBy"),   $lang->user->openedBy);
  echo html::a(inlink('bug', "userID={$user->id}&type=resolvedBy"), $lang->user->resolvedBy); 
  echo html::a(inlink('bug', "userID={$user->id}&type=closedBy"),   $lang->user->closedBy);
  ?>
