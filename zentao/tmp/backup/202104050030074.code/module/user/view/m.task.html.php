...
<?php
echo html::a(inlink('task', "userID={$user->id}&type=assignedTo"), $lang->user->assignedTo);
echo html::a(inlink('task', "userID={$user->id}&type=openedBy"),   $lang->user->openedBy);
echo html::a(inlink('task', "userID={$user->id}&type=finishedBy"), $lang->user->finishedBy);
echo html::a(inlink('task', "userID={$user->id}&type=closedBy"),   $lang->user->closedBy);
echo html::a(inlink('task', "userID={$user->id}&type=canceledBy"), $lang->user->canceledBy);
?>
